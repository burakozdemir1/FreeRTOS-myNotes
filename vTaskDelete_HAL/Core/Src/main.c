...
/* USER CODE BEGIN Header_Task1Handler */
/**
...
void Task1Handler(void const * argument)
{
  ...
  for(;;)
  {
	  ...
	  //osDelay(1); // vTaskDelay(); ile aynı şeyler
  }
  /* USER CODE END 5 */
}

/* USER CODE BEGIN Header_Task2Handler */
/**
	 ...
	 buttonState = HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_13);
	  	  if(buttonState==GPIO_PIN_SET)
	  	  {
	  		 // while(HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_13)==1);
	  		  ...
	  		  //vTaskDelete ile aynı işi yapar
	  	  }


    //osDelay(1);
  }
  /* USER CODE END Task2Handler */
}
